...
$curl1= @"
sudo curl -Sks https://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/SLES15_SP3_SAP_VCT_dev_apac_x86_64.sh | bash
"@
...
$curl2= @"
sudo curl -Sks https://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/SLES15_SP3_SAP_VCT_prod_apac_x86_64.sh | bash
"@
...
$curl3= @"
sudo curl -Sks https://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/SLES15_SP3_SAP_VCT_int_apac_x86_64.sh | bash
"@
...
$curl4= @"
sudo curl -Sks https://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/SLES15_SP3_VCT_dev_apac_x86_64.sh | bash' >> /var/tmp/suma4.sh
"@
...
$curl5= @"
sudo curl -Sks https://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/SLES15_SP3_VCT_prod_apac_x86_64.sh | bash
"@
...
$curl6= @"
sudo curl -Sks https://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/SLES15_SP3_VCT_int_apac_x86_64.sh | bash
"@
...
$curl7= @"
sudo curl -Sks http://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/APAC-SLES12SP5SAPx8664-SP5-202302-vm-base.sh | bash
"@
...
write-host "Running SLES:12 NONSAP Prod/QA/Test/Int SUMA..." -ForegroundColor Green

$curl7= @"
sudo curl -Sks http://sashsm000011.adc-apac.corpintra.net/pub/bootstrap/APAC-SLES12SP5x8664-SP5-202302-vm-base.sh | bash
"@
        $Invokecurl7=Invoke-VMScript -VM $vm -ScriptType bash -ScriptText $curl7  -Verbose -GuestCredential $cred
